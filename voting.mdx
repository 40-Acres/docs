...
How 40 Acres votes with your veNFT to maximize epoch rewards.

## The Vote Optimizer

When you deposit a veNFT into 40 Acres, the protocol's vote optimizer automatically allocates your voting power each epoch to maximize the rewards your position generates.
...
The Voting Terminal is 40 Acres' interface for managing votes, exploring pool yields, and tracking your epoch performance. You can:
