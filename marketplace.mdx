...
Buy, sell, and bootstrap veNFT positions on 40 Acres. sidebar
...
The Marketplace integrates KyberSwap limit orders for veNFT transactions. Instead of accepting spot price, sellers can set a target price and the order fills when market conditions meet it.

This gives sellers price control over their locked positions and gives buyers the ability to set bids on specific veNFTs or position sizes they want.
