...
40 Acres uses a peer-to-pool lending model. Lenders deposit USDC into the vault. That USDC is used to fund borrower loans. Each epoch, borrowers' veNFT rewards are collected and distributed back to lenders as yield.
...
- **Reward variability**: Yields are tied to epoch performance. A weak epoch means less yield that week.
...
→ [Read the full risk disclosure](/security/risks)