...
2. **Select your veNFT** from the list of eligible collateral
...
- Your veNFT votes each epoch via the vote optimizer
...
Once a loan is open, you can increase your borrowing capacity by adding more collateral to your position; either by depositing additional veNFTs or, with Portfolio Accounts, by adding other yield-bearing assets.

Navigate to your active position → Top Up → select additional collateral.

## Closing a Position

When your loan balance reaches zero, your veNFT is automatically returned to your wallet. No action required.
